...
SteamWatch sends network requests to public third-party services only to fetch data needed for tracked games:
...
These requests are limited to games the user chooses to track or searches for inside the extension.
...
SteamWatch does not sell user data and does not transfer user data to third parties except for the public data requests required to provide its single purpose: tracking selected Steam games.
